...
// ================= الأدوار =================
const MOD_AR = { dashboard: 'اللوحة', tasks: 'المهام', appointments: 'المواعيد', clients: 'العملاء', calls: 'الاتصالات', notes: 'الملاحظات', files: 'الملفات', notifications: 'الإشعارات', users: 'المستخدمون', roles: 'الأدوار', audit: 'السجل', settings: 'الإعدادات', reports: 'التقارير', projects: 'المشاريع', units: 'الوحدات', reservations: 'الحجوزات', sales: 'المبيعات', finance: 'المالية', backup: 'النسخ', assistant: 'المساعد' };
