  ...
  if (fin) {
    ...
    p.table({
      ...
      rows: [
        ...
        { k: 'صافي الربح الحقيقي', v: { t: money(fin.net_profit), c: fin.net_profit >= 0 ? '#1e6b4f' : '#982d36' }, n: 'على أساس التحصيل' },
...
const RENDERERS = {
  ...
  sale: renderSale, sale_invoice: renderSale, marketer_settlement_invoice: renderMarketerSettlementInvoice, sales_report: renderSalesReport, payments_report: renderPaymentsReport,
