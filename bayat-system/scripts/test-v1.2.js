...
(async () => {
  ...
  const sale2 = await call(TRES, 'POST', '/api/sales', { unit_id: u2, sale_date: '2026-08-18', base_price: 595000, discount_type: 'amount', discount_value: 15000, payment_method: 'cash', paid_amount: 580000 });
