...
const MODULES = ['dashboard','tasks','appointments','clients','calls','notes','files','notifications','users','roles','audit','settings','reports','projects','units','reservations','sales','finance','backup','brokers','templates','branding','ai','assistant'];
...
function seedCore() {
  ...
  grantAll(adminR);
  ['dashboard','clients','files','reports','finance','sales','reservations','brokers','assistant','notifications'].forEach(m =>
  ...
  ['dashboard','clients','projects','units','reservations','sales','brokers','calls','notes','files','reports','assistant','notifications','tasks','appointments'].forEach(m =>
  ...
  ['dashboard','tasks','appointments','clients','calls','notes','files','notifications','reports','assistant','projects','units','reservations','templates'].forEach(m =>
